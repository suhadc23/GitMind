...
import { GitPullRequest, Plus, MessageSquare, Users, Loader2 } from 'lucide-react'
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">AI-powered collaborative pull request reviews</p>
            </div>
          </div>
